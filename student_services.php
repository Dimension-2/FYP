...
if (isset($_GET['delete_id'])) {
    ...
    // CHANGE: Use the variable defined at the top of your file
    ...
    if ($stmt = $conn->prepare("DELETE FROM student_services WHERE id = ? AND registration_no = ?")) {
        ...
        if ($stmt->execute()) {
            ...
            if ($stmt->affected_rows > 0) {
                ...
                $status = "error"; // ID didn't exist or didn't match registration_no
            }
            $stmt->close();

            // Redirect back to clean the URL
            header("Location: student_services.php?msg=" . $status);
            exit();
        } else {
...
// Fetching history after potential deletion
// Fetching history after potential deletion
// CHANGE: Wrap $registration_no in braces or concatenate properly to ensure string parsing
...
<head>
    ...
    <link rel="stylesheet" href="includes/navbar.php">
                            ...
                            <tbody>
                                <?php while ($row = $history->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="student_services.php?delete_id=<?php echo $row['id']; ?>"
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 mt-4">
                            <h6 class="fw-bold text-muted text-uppercase small border-bottom pb-2">Academic Record</h6>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="processing_speed" class="form-select border-primary-subtle bg-light-primary">
                        ...
                        <div class="col-md-12">
                            <div class="row g-3 p-3 bg-light rounded-3 border">
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold"><i class="bi bi-card-image me-1"></i>Student
                                        CNIC (Front)</label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold"><i
                                            class="bi bi-file-earmark-check me-1"></i>Intermediate Certificate</label>
        ...
        <div class="modal-dialog modal-lg">
            <form class="modal-content border-0 shadow-lg" method="POST" enctype="multipart/form-data"
                ...
                <div class="modal-header bg-success text-white p-4" style="border-radius: 25px 25px 0 0;">
                    <h5 class="fw-bold mb-0"><i class="bi bi-shield-check me-2"></i>Final Departmental Clearance</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            <h6 class="fw-bold text-muted text-uppercase small border-bottom pb-2">Academic Profile</h6>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light" value="<?php echo $raw_roll; ?>" readonly>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small fw-bold">Department HOD Name</label>
                            <input type="text" name="department_hod" class="form-control" placeholder="Enter HOD Name"
                                required>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label small fw-bold">Gender</label>
                        ...
                        <div class="col-12" id="clearance_upload_container" style="display: block !important;">
                            ...
                            <div class="form-text">Please upload a scanned copy or image of your clearance slip.</div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="p-3 border-start border-4 border-success bg-light rounded-3">
                                <p class="small text-muted mb-0">
                                    ...
                                    <strong>Note:</strong> Once submitted, your request will move to the Admin dashboard
